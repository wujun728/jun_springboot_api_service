...
$(function(){
	$('#infoList').datagrid({
		...
		url:"<%=path%>/NhEsbServiceServlet?cmdName=Groovy&subName=match_mvc_sale_list&groovySubName=getInfoList4Page",
		columns:[[
					{
						field : 'id',
						title : 'id',
...
//撮合
	...
	function doMatch(){  
	    ...
	    if(sels==""||sels==null){
	    	...
	    	var sels = $("#infoList").datagrid("getSelected");
	    	var id=sels.id;
			var url="<%=path%>/NhEsbServiceServlet?cmdName=Groovy&subName=match_mvc_sale_list&groovySubName=execMatch&recordId="+id;
	...
	function addOne(){
		...
		var url="<%=path%>/NhEsbServiceServlet?cmdName=Groovy&subName=match_mvc_sale_list&groovySubName=createInfo";
	...
	function updateOne(){
		var url="<%=path%>/NhEsbServiceServlet?cmdName=Groovy&subName=match_mvc_sale_list&groovySubName=updateInfo";
	...
	function remove(){
		...
		if(sels == ''|| sels==null){
			...
			if(result == true){
				var querydata = $('#searchForm').serializeObject();
				var id = sels.id;
				var url="<%=path%>/NhEsbServiceServlet?cmdName=Groovy&subName=match_mvc_sale_list&groovySubName=delInfo";
				url=url+"&id="+id;
				$.post(url,function(data,stats){
							if(stats=="success" ){
								$.messager.show({
		...
		<form id="updateOneForm" novalidate method="post" action="">
			...
			<table id="updateTable"
				...
				<tr>
					...
					<td><input  id="borrow_no" name="borrow_no" value=""></input></td>
				</tr>
				<tr>
