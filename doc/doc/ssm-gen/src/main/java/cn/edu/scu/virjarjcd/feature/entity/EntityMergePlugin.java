package cn.edu.scu.virjarjcd.feature.entity;
...
public class EntityMergePlugin extends MergePluginAdpter {
	...
	public boolean calcEnv() {
		...
		modelPackage = ConfigHolder.instance.getProperty("sys.basePackage")+".entity";
		ConfigHolder.instance.setProperty("sys.modelPackage", modelPackage);

		javaSourcePath = ConfigHolder.instance.getProperty("sys.service.javasourcepath");
