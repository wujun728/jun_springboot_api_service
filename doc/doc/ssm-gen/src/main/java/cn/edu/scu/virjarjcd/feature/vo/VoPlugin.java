...
public class VoPlugin extends MergePluginAdpter {
	...
	public boolean calcEnv() {
		...
		modelPackage = ConfigHolder.instance.getProperty("sys.basePackage")+".vo";
		ConfigHolder.instance.setProperty("sys.modelPackage", modelPackage);

		javaSourcePath = ConfigHolder.instance.getProperty("sys.webapp.javasourcepath");
	...
	public List<GeneratedJavaFile> mergeAdditionalJavaFiles(
		...
		String domainName = introspectedTable.getFullyQualifiedTable().getDomainObjectName()+"VO";
