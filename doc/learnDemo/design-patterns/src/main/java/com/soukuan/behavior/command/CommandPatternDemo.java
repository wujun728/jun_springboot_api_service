...
public class CommandPatternDemo {
    ...
    public static void main(String[] args) {
        Receiver turnOnReceiver = new TurnOnReceiver();
        Receiver turnOffReceiver = new TurnOffReceiver();
        Invoker invoker = new Invoker();

        Command turnOnLight = new LightOnCommand(turnOnReceiver);
        Command turnOffLight = new LightOffCommand(turnOffReceiver);
