...
public class Groovy {
    ...
    public static void main(String[] args) {
        ...
        Object res3 = groovy.runGroovyScript("return new groovy.json.JsonSlurper().parseText('{ \"name\": \"John Doe\" }').name",params);
        System.out.println(res3);

        Object res4 = groovy.runGroovyScriptByFile(null, "hello.groovy", "hello", new String[] { "param3", "param4" });
